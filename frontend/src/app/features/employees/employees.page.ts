...
export class EmployeesPage implements OnInit {
  ...
  openEdit(employee: Employee): void {
    ...
    this.form.reset({
      ...
      officeStartsAt: employee.officeStartsAt ?? '',
      officeEndsAt: employee.officeEndsAt ?? '',
  ...
  submit(): void {
    ...
    const request = editing
      ? this.api.put<Employee>(`/employees/${editing.id}`, {
          ...
          officeStartsAt: optional(raw.officeStartsAt),
          officeEndsAt: optional(raw.officeEndsAt),
  ...
  changeEmploymentStatus(employee: Employee, status: 'Active' | 'Inactive'): void {
    ...
    this.api.put<Employee>(`/employees/${employee.id}`, {
      ...
      officeStartsAt: employee.officeStartsAt ?? null,
      officeEndsAt: employee.officeEndsAt ?? null,
      baseSalary: employee.baseSalary,
      salaryCurrency: employee.salaryCurrency,
      version: employee.version,
