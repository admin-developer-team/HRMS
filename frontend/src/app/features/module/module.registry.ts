        ...
        fields: [
          { key: 'name', label: 'Role name', type: 'text', required: true },
          {
            ...
            options: [
              ...
              { label: 'Read work projects', value: 'work.read' },
              { label: 'Create and edit work items', value: 'work.create' },
              { label: 'Assign work items', value: 'work.assign' },
              { label: 'Transition work items', value: 'work.transition' },
              { label: 'Comment on work items', value: 'work.comment' },
              { label: 'Log time on work items', value: 'work.log' },
              { label: 'View other employees worklogs', value: 'work.view-all-logs' },
              { label: 'Administer work projects', value: 'work.manage' },
            ],
          },
        ],
      },
