        ...
        rowActions: [
          {
            ...
            fields: [
              ...
              { key: 'subscriptionStartsAt', label: 'Subscription starts', type: 'datetime-local', required: true },
              { key: 'subscriptionEndsAt', label: 'Subscription ends', type: 'datetime-local' },
              { key: 'subscriptionActive', label: 'Subscription enabled', type: 'checkbox' },
              versionField,
    ...
    views: [
      {
        ...
        rowActions: [
          ...
          {
            label: 'Reset password', icon: 'password', method: 'put', path: '/identity/users/{id}/password',
            fields: [{ key: 'password', label: 'New temporary password', type: 'password', required: true, help: 'At least 8 characters. Existing sessions will be signed out.' }],
          },
          {
            label: 'Deactivate account', icon: 'person_off', tone: 'danger', method: 'put', path: '/identity/users/{id}/active',
            visibleField: 'isActive', visibleValues: ['true'],
            fields: [{ key: 'isActive', label: 'Active', type: 'checkbox', defaultValue: false, sourceKey: '_deactivate', hidden: true }, versionField],
          },
          {
            label: 'Activate account', icon: 'person', method: 'put', path: '/identity/users/{id}/active',
            visibleField: 'isActive', visibleValues: ['false'],
            fields: [{ key: 'isActive', label: 'Active', type: 'checkbox', defaultValue: true, sourceKey: '_activate', hidden: true }, versionField],
          },
        ],
      },
      {
        ...
        fields: [
          { key: 'name', label: 'Role name', type: 'text', required: true },
          {
            ...
            type: 'multiselect',
            required: true,
            help: 'Select a parent permission first to unlock its actions. Turning off a parent removes its child permissions.',
            options: [
              { label: 'All tenant permissions', value: '*', group: 'Full access' },
              { label: 'Admin dashboard', value: 'dashboard.admin', group: 'Overview' },
              { label: 'Employees access (read)', value: 'employees.read', group: 'People · Employees' },
              { label: 'Manage employees', value: 'employees.manage', group: 'People · Employees', parent: 'employees.read' },
              { label: 'Manage organization', value: 'organization.manage', group: 'People · Employees', parent: 'employees.read' },
              { label: 'Manage leave', value: 'leave.manage', group: 'People' },
              { label: 'Manage attendance', value: 'attendance.manage', group: 'People' },
              { label: 'Manage workforce', value: 'workforce.manage', group: 'People' },
              { label: 'Manage payroll', value: 'payroll.manage', group: 'Compensation' },
              { label: 'Manage expenses', value: 'expenses.manage', group: 'Compensation' },
              { label: 'Work management access (read)', value: 'work.read', group: 'Delivery · Work management' },
              { label: 'Create and edit work items', value: 'work.create', group: 'Delivery · Work management', parent: 'work.read' },
              { label: 'Assign work items', value: 'work.assign', group: 'Delivery · Work management', parent: 'work.read' },
              { label: 'Transition work items', value: 'work.transition', group: 'Delivery · Work management', parent: 'work.read' },
              { label: 'Comment on work items', value: 'work.comment', group: 'Delivery · Work management', parent: 'work.read' },
              { label: 'Log time on work items', value: 'work.log', group: 'Delivery · Work management', parent: 'work.read' },
              { label: 'View other employees worklogs', value: 'work.view-all-logs', group: 'Delivery · Work management', parent: 'work.read' },
              { label: 'Administer work projects', value: 'work.manage', group: 'Delivery · Work management', parent: 'work.read' },
              { label: 'Manage recruitment', value: 'recruitment.manage', group: 'Talent' },
              { label: 'Manage performance', value: 'performance.manage', group: 'Talent' },
              { label: 'Manage training', value: 'training.manage', group: 'Talent' },
              { label: 'Manage assets', value: 'assets.manage', group: 'Operations' },
              { label: 'Manage users and roles', value: 'identity.manage', group: 'Operations' },
              { label: 'Read audit logs', value: 'audit.read', group: 'Operations' },
              { label: 'Employee self-service', value: 'self.service', group: 'Self service' },
              { label: 'My team access (read)', value: 'team.read', group: 'Self service · My team' },
              { label: 'Approve direct-report requests', value: 'team.approve', group: 'Self service · My team', parent: 'team.read' },
            ],
          },
        ],
      },
