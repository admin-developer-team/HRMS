    ...
    public static IReadOnlyList<EmailTemplate> CreateDefaults(Guid tenantId)
    {
        ...
        var rows = new List<EmailTemplate>
        {
            ...
            New(tenantId, EmailTemplateKeys.AccountCreated, "Account created", "Your {{companyName}} HRMS account is ready",
                html.Replace("{{message}}", "Your PeopleFlow account has been created. Use the secure link below to open your workspace. The link expires after 24 hours and can be used once."),
                "Hello {{recipientName}},\n\nYour PeopleFlow account has been created. Use this secure link to open your workspace. It expires after 24 hours and can be used once.\n\n{{actionUrl}}"),
            New(tenantId, EmailTemplateKeys.PasswordReset, "Password reset", "Your {{companyName}} HRMS password was reset",
                html.Replace("{{message}}", "An administrator reset your password. Use the secure link below to open your workspace. The link expires after 24 hours and can be used once."),
                "Hello {{recipientName}},\n\nAn administrator reset your password. Use this secure link to open your workspace. It expires after 24 hours and can be used once.\n\n{{actionUrl}}"),
