...
public sealed record BillingCheckoutResult(string SubscriptionId, string CheckoutUrl, string Provider = "razorpay", bool TestMode = false);
...
public sealed record BillingStatus(string PlanCode, bool Active, DateTimeOffset? EndsAt, string? PendingPlanCode, string? PendingStatus, string? PendingCheckoutUrl, bool TestMode, DateTimeOffset? TrialEndsAt, string? PendingProvider = null);
