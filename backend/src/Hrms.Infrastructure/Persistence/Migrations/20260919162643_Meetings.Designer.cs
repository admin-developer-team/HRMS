...
namespace Hrms.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919162643_Meetings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hrms.Domain.AccountActivation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hrms.Domain.AttendanceCorrection", b =>
                {
                    ...
                    b.Property<long?>("OriginalRecordVersion")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Hrms.Domain.AttendancePolicy", b =>
                {
                    ...
                    b.Property<TimeOnly>("OfficeEndsAt")
                    ...
                    b.Property<string>("WorkingDaysCsv")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Hrms.Domain.AttendanceRecord", b =>
                {
                    ...
                    b.HasIndex("TenantId", "EmployeeId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false AND \"ClockedOutAt\" IS NULL");
            ...
            modelBuilder.Entity("Hrms.Domain.BillingCheckout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BillingCheckouts");
                });

            modelBuilder.Entity("Hrms.Domain.BillingWebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hrms.Domain.EmployeePayrollProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("HraPercentOfBasic")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("OtherMonthlyDeduction")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.ToTable("EmployeePayrollProfiles");
                });
            ...
            modelBuilder.Entity("Hrms.Domain.HolidaySelection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "HolidayId", "EmployeeId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("HolidaySelections");
                });
            ...
            modelBuilder.Entity("Hrms.Domain.Meeting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hrms.Domain.MeetingAttendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "EmployeeId", "MeetingId");

                    b.HasIndex("TenantId", "MeetingId", "EmployeeId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
            ...
            modelBuilder.Entity("Hrms.Domain.PayrollAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "PayrollRunId", "EmployeeId", "Code")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
            ...
            modelBuilder.Entity("Hrms.Domain.PayrollPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("DeductHalfDays")
                        .HasColumnType("boolean");

                    b.Property<bool>("DeductUnpaidLeave")
                        .HasColumnType("boolean");
                    ...
                    b.Property<decimal>("EsiGrossCeiling")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<string>("MissingAttendance")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PayableDaysBasis")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("ReleasePayslipsOnApproval")
                        .HasColumnType("boolean");

                    b.Property<bool>("RequireStatutoryReview")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Hrms.Domain.PayrollRun", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("StatutoryReviewedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("StatutoryReviewedBy")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hrms.Domain.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hrms.Domain.TenantSubscription", b =>
                {
                    ...
                    b.HasIndex("BillingProvider", "ProviderSubscriptionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Hrms.Domain.UserAccount", b =>
                {
                    ...
                    b.Property<bool>("SupportInboxEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Hrms.Domain.WorkItem", b =>
                {
                    ...
                    b.Property<Guid?>("ReporterEmployeeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "Status", "AssigneeEmployeeId");
            ...
            modelBuilder.Entity("Hrms.Domain.WorkItemAssignee", b =>
                {
                    ...
                    b.HasIndex("TenantId", "EmployeeId", "WorkItemId");

                    b.HasIndex("TenantId", "WorkItemId", "EmployeeId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
            ...
            modelBuilder.Entity("Hrms.Domain.WorkMention", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "SourceType", "SourceId", "EmployeeId")
                        .IsUnique();

                    b.ToTable("WorkMentions");
                });
            ...
            modelBuilder.Entity("Hrms.Domain.WorkProjectMember", b =>
                {
                    ...
                    b.Property<bool>("CanAssignItems")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanCreateItems")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanLogWork")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanTransitionItems")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanViewAllWorklogs")
                        .HasColumnType("boolean");
